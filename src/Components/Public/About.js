...
function About() {
  return (
    ...
    <main class="container mx-auto mt-10 p-5">
        <section class="text-primary-dark p-6">
        ...
        <section class="mt-8 text-primary-dark">
        ...
        <section class="mt-8 text-primary-dark">
            ...
            <Link to={SIGNUP} class="mt-4 inline-block bg-primary-light text-white px-4 py-2 rounded-lg hover:shadow-md shadow-gray-300 transition duration-300">Try It Now</Link>
        </section>
    </main>
    </>
  )
