...
function Signup() {
    return (
        <div>
            <div class="relative">
                <input type="text" id="floating_outlined" className=" w-1/2 block px-2.5 pb-2.5 pt-4 text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 ring-1  focus:outline-1 focus:ring-1 focus:border-blue-600 peer" placeholder=" " />
